...
The same reader communities also criticise:
...
- romance that explains feelings after already showing them
- overextended flashbacks that starve present-time momentum

## Tool Implications

Novel Craft should push agents to:

- generate more than one contender before drafting
