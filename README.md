...
[![CI](https://github.com/da393/novel-craft/actions/workflows/ci.yml/badge.svg)](https://github.com/da393/novel-craft/actions/workflows/ci.yml)
...
See [docs/npm-install.md](https://github.com/da393/novel-craft/blob/main/docs/npm-install.md) for local install, `npx`, and PATH troubleshooting.
...
See [docs/source-policy.md](https://github.com/da393/novel-craft/blob/main/docs/source-policy.md).
...
The Rust CLI is the only supported public implementation. Historical Python prototype files are intentionally excluded from the public release tree.
...
See [docs/npm-publish.md](https://github.com/da393/novel-craft/blob/main/docs/npm-publish.md) and [docs/release-process.md](https://github.com/da393/novel-craft/blob/main/docs/release-process.md).

## Governance

Public PRs are welcome, but merges and releases are guarded by maintainer review, CODEOWNERS, branch protection, and CI. See:

- [CONTRIBUTING.md](https://github.com/da393/novel-craft/blob/main/CONTRIBUTING.md)
- [SECURITY.md](https://github.com/da393/novel-craft/blob/main/SECURITY.md)
- [GOVERNANCE.md](https://github.com/da393/novel-craft/blob/main/GOVERNANCE.md)
- [docs/release-process.md](https://github.com/da393/novel-craft/blob/main/docs/release-process.md)
