...
Configure these settings after creating `github.com/da393/novel-craft` as a private repository. Keep it private until the clean root commit, CI, npm package dry run, and leak checks have passed.
