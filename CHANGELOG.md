...
- Add `eval gate` with constraint checks, lint summary, reader warnings, lexical novelty signals, and human/LLM judgement reminders.
...
- Add opening micro-promise checks so first chapters show a small dramatic unit before announcing macro-scale systems, kingdoms, domains, or upgrade ladders.
...
- Tighten README and CLI docs around agent usage, packaged contents, and model boundaries.
